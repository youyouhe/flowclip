...
revision = '001_add_processing_status_tables'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('videos', sa.Column('processing_metadata', sa.JSON(), nullable=True, server_default='{}'))
    ...
    op.create_table('processing_tasks',
        ...
        sa.Column('task_metadata', sa.JSON(), nullable=True, server_default='{}'),
