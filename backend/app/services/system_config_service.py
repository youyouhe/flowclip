...
class SystemConfigService:
    ...
    def get_configurable_items() -> List[Dict[str, str]]:
        ...
        return [
            ...
            {"key": "jianying_api_url", "label": "Jianying API URL", "category": "其他服务配置", "default": getattr(settings, 'jianying_api_url') or '', "description": "Jianying API服务的URL地址，用于剪映视频编辑功能"},
            {"key": "jianying_api_key", "label": "Jianying API密钥", "category": "其他服务配置", "default": getattr(settings, 'jianying_api_key') or '', "sensitive": True, "description": "Jianying API密钥，用于访问剪映服务"},
            {"key": "jianying_draft_folder", "label": "Jianying草稿文件夹路径", "category": "其他服务配置", "default": getattr(settings, 'jianying_draft_folder') or '剪映草稿', "description": "Jianying导出的默认草稿保存文件夹路径，支持Windows和Unix路径格式"},
